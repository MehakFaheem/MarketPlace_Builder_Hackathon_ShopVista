          ...
          <div className="mb-8">
            <nav className="text-sm mb-4">
              <ol className="flex items-center space-x-2">
                <li><Link href="/home" className="text-black hover:text-gray-800">Home •</Link></li>
                <li><Link href="/faq" className="text-black hover:text-gray-800">Pages •</Link></li>
                <li><Link href="/faq" className="text-pink-700 hover:text-gray-800">FAQ</Link></li>
              </ol>
            </nav>
          </div>
        </div>
